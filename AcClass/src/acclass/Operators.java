...
public class Operators {
    Operators(){
        ...
        */
        ...
        >= (greater than or equal to) :  Checks if the values of two operands, 
             is greater or equal to returns true
        
        <= (greater than or equal to) :  Checks if the values of two operands, 
                     is less or equal returns true
        ...
        */
        ...
        Syntax:
        && (logical and) : works is both the operands are non-zero the the 
...
//      >> (Right shift) : Binary Right Shift Operator where the left operands values is 
 ...
 //       >>> (Zero fill right shift) : Shift right zero fill Operator where the
               // left operands values is moved right
        // by the number of bits specified by the right operand and shifted 
            //values are filled up with zero
        
        ans = i >>> 2;
        System.out.println("Zero fill right shift >>> 2 is: " + ans); // 0000 1111 is
//        binary of 15
